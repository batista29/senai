const clientes = (lista) => {
    //Para cada elemento da lista removemos os campos telefone e tipo e criamos uma sublista chamada telefones
    lista.forEach(e => {
        e.telefones = [];
        let tel = {};
        tel.tipo = e.tipo;
    ...
    //Criar uma nova lista sem os dados duplicados (Comparando o proximo item com o anterior)
